...
## Stats
As of Oct 21 2023:
  * The benchmark consists of 571 reproducible breaking updates from 153 unique projects.
    - Of these breaking updates, 243 (42.56%) fail compilation with the updated dependency.
    - 188 (32.92%) fail tests with the updated dependency.
    - 5 (0.88%) have dependency resolution failures with the updated dependency.
    ...
    - 14 (2.45%) fail due to dependency locks.
  ...
  * Overall, reproduction has been attempted for 5334 breaking updates, and 4763 (89.30%) could not be locally reproduced.
